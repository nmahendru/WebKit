...
enum class IsCopyable : bool { No, Yes };
...
template<typename, size_t = 0, typename = CrashOnOverflow, size_t = 16, typename = VectorBufferMalloc, IsCopyable = IsCopyable::Yes> class Vector;
